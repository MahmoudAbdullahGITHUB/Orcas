...
import com.example.orcas.ui.dialogs.ConfirmInfoDialog
...
fun Context.createMaterialCard(): MaterialCardView {
    return MaterialCardView(this).apply {
        ...
        radius = resources.getDimension(com.intuit.sdp.R.dimen._4sdp)
        elevation = resources.getDimension(com.intuit.sdp.R.dimen._2sdp)
    }
}
